...
DATA_INGESTION_COLLECTION_NAME: str = "stroke_raw"
DATA_INGESTION_DATABASE_NAME: str = "Stroke"

# Folder structure within artifacts for data ingestion
DATA_INGESTION_DIR_NAME: str = "data_ingestion"
DATA_INGESTION_FEATURE_STORE_DIR: str = "raw_data"  # Raw snapshot of dataset
...
TRAINING_BUCKET_NAME: str = "Autocare_stroke_bucket"
