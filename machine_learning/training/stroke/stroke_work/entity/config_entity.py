...
import os
from machine_learning.training.stroke.stroke_work.constant.training_pipeline import constant
...
class ModelTrainerConfig:
    ...
    def __init__(self, training_pipeline_config: TrainingPipelineConfig):
        ...
        self.model_dir: str = os.path.join(
            "machine_learning", "training", "stroke", "stroke_work", "model_processor"
        )
        os.makedirs(self.model_dir, exist_ok=True)
