#import
import sys
from machine_learning.training.stroke.stroke_work.entity.artifact_entity import ClassificationMetricArtifact
...
def get_classification_score(y_true, y_pred) -> ClassificationMetricArtifact:  #type: ignore
    ...
    try:
        ...
        model_accuracy_score = accuracy_score(y_true, y_pred) * 100   # Convert to %
        ...
        classification_metric = ClassificationMetricArtifact(
            ...
            accuracy_score=model_accuracy_score   # type: ignore
