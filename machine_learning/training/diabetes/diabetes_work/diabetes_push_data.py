...
# ---------------- Internal Imports ----------------
from autocare_utils.exception import AutoCareException  # custom exception
from autocare_utils.logging import logging                        # custom logger
...
if __name__ == "__main__":
    # Input CSV file path
    FILE_PATH = "machine_learning/training/diabetes/diabetes_data/Diabetes_Final_data.xlsx"
    # Target MongoDB database
    DATABASE = "Diabetes"
    # Target MongoDB collection
    COLLECTION = "diabetes_raw"
