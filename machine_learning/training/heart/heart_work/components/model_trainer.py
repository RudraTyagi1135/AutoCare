# machine_learning/training/heart/heart_work/components/model_trainer.py
import os
import sys
import time
import json
...
class ModelTrainer:
    """
    Heart Model Trainer — consistent with Diabetes trainer, builds inference pipeline and saves artifacts.
    """
    ...
    def __init__(self, model_trainer_config: ModelTrainerConfig, data_transformation_artifact: DataTransformationArtifact):
        try:
            ...
            logging.info("✅ Heart ModelTrainer created.")
    ...
    def initiate_model_trainer(self) -> ModelTrainerArtifact:
        try:
            logging.info("🚀 Starting Heart model training...")
            ...
            logging.info("✅ Heart Model training completed.")  
