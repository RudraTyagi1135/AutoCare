...
from machine_learning.training.heart.heart_work.entity.config_entity import DataIngestionConfig
from machine_learning.training.heart.heart_work.entity.artifact_entity import DataIngestionArtifact
